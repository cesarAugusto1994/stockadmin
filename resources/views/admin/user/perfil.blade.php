    ...
    <div class="col-md-2">
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          ...
          <a href="{{ $user->permalink }}" target="_blank" class="btn btn-warning btn-block"><b>Acessar Perfil ML</b></a>
        </div>
        <!-- /.box-body -->
      </div>
      <!-- /.box -->
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <strong><i class="fa fa-phone margin-r-5"></i> Contatos</strong>

          <p class="text-muted">
            Telefone: {{ $user->phone->number }}
          </p>
